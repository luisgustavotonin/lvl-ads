...
const TABS = [
  ...
  { id: 'account',     label: 'Conta (Alcance)',   entity: 'MetricsAccountLevel',           hasDate: true },
...
const COLUMNS = {
  base: [
    ...
    { key: 'reach',       label: 'Alcance',     render: r => fmtNum(r.reach) },
  ...
  account: [
    { key: 'date',        label: 'Data',        render: r => fmtDate(r.date) },
    { key: 'account_id', label: 'Account ID',   render: r => r.account_id || '—' },
    { key: 'spend',       label: 'Gasto',        render: r => fmtCur(r.spend) },
    { key: 'impressions', label: 'Impressões',  render: r => fmtNum(r.impressions) },
    { key: 'reach',       label: 'Alcance (conta)', render: r => fmtNum(r.reach) },
    { key: 'clicks',      label: 'Cliques',     render: r => fmtNum(r.clicks) },
    { key: 'link_clicks', label: 'Cliques Link',render: r => fmtNum(r.link_clicks) },
  ],
};
